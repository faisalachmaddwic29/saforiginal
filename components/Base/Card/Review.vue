<template>
	<div class="group cursor-pointer w-full bg-white text-[#1E293B] dark:bg-[#0F172A] dark:text-white rounded overflow-hidden flex-shrink-0" @click="handleClick">
		<div class="flex gap-2.5 p-4 border border-[rgba(148,163,184,0.12)]">
			<!-- Image -->
		...
		<div class="flex justify-between items-center gap-2.5 px-4 py-2 bg-[#F4F4F4] dark:bg-[#091122]">
			<div class="flex flex-col">
				<p class="text-xs md:text-base font-normal text-[#627086] dark:text-[#94A3B8]">Beri ulasan pembelian ini</p>
			...
			<div class="flex gap-2.5 h-7">
				...
				<button v-if="props.review" class="text-sm md:text-base btn-secondary-outline">Perbarui</button>
			</div>
		</div>
	</div>
</template>
