<template>
  <div class="group bg-transparent overflow-hidden cursor-pointer transition duration-200 flex-shrink-0" :class="{ 'w-full': isFull, 'w-[180px] md:w-[210px]': !isFull }" @click="handleClick">
