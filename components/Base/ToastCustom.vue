...
<template>
  ...
  >
    <!-- Icon -->
    <div
      class="inline-flex items-center justify-center shrink-0 w-10 h-10 rounded-full"
      :class="typeClass[type].iconColor"
    >
    ...
    <button
      type="button"
      class="absolute right-1 top-1 bg-white text-gray-400 hover:text-gray-900 rounded-full focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-6 w-6 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
      @click="handleClick"
      aria-label="Close"
    >
