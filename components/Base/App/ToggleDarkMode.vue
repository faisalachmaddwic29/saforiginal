  ...
  <div class="flex flex-col items-center gap-2">
		<ClientOnly>
			...
			>
				<!-- Toggle Button -->
				<div
					class="absolute top-0.5 w-6 h-6 rounded-full transition-all duration-300 ease-in-out flex items-center justify-center shadow-md"
					:class="[
						isDark
				...
				>
					...
					<Icon
						...
						:class="[
							...
							isDark ? 'text-slate-300' : 'text-[#FF9600]'
						]"
					/>
				</div>
				...
				<div class="absolute inset-0 flex items-center justify-between px-2 pointer-events-none">
					...
					<Icon
						...
						:class="isDark ? 'text-slate-600 opacity-50' : 'text-[#FF9600] opacity-80'"
					/>
					<!-- Moon Icon (Right side) -->
					<Icon
						name="material-symbols:dark-mode"
						class="text-sm transition-all duration-300 mr-[1px]"
						:class="isDark ? 'text-slate-300 opacity-80' : 'text-slate-400 opacity-50'"
					/>
				</div>
			</div>
		</ClientOnly>
