<template>
	<form @submit.prevent="onSubmit" class="flex flex-col min-dvh-screen px-4 py-5 relative">
		...
		<div class="my-5">
			...
			<p class="mt-2 text-xs md:text-sm text-[#1E293B] dark:text-[#94A3B8]">Tidak menerima kode verifikasi? <span @click="sendOtp" class="text-primary font-bold pl-0.5">Kirim ulang</span></p>
