<template>
	<div class="home">
		...
		<div class="px-4">
			<TitleWithOthers label="Rekomendasi Untukmu" @click="goToOtherPage('1')" />
		</div>

		<div class="overflow-x-auto flex whitespace-nowrap gap-4 py-4 px-4">
			<CardUlasan />
		</div>

		<div class="overflow-x-auto flex whitespace-nowrap gap-4 py-4 px-4">
			<CardMerchandise />
			<CardMerchandise id="2" title="Buku Lapis Lapis Keberkahan kasdkaso sdasd" />
			<CardMerchandise id="3" thumbnail="/images/sample.png" />
			<CardMerchandise id="4" />
		</div>
