<template>
  <form class="p-4 flex flex-col gap-6 text-sm md:text-base" @submit.prevent="onSubmit">
    ...
    <div class="flex flex-col gap-2">
      <LabelSection>Total Harga Produk</LabelSection>
      <ClientOnly>
...
const selectedItems = JSON.parse(route.query.selectedItems as string) as {
  qty: number;
  unitPrice: number;
};
console.log(selectedItems);
// const selectedItems = Object.values(JSON.parse(route.query.selectedItems as string));
